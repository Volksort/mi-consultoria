  ...
  return (
    <main className="bg-[#f4f5f7] min-h-screen">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              <button className="bg-white text-emerald-700 px-6 py-3 rounded-xl font-semibold shadow hover:scale-105 transition">
                Agenda una asesoría gratuita
              </button>
              <button className="border border-white px-6 py-3 rounded-xl font-semibold hover:bg-white hover:text-emerald-700 transition">
                Ver servicios
              </button>
            </div>
          </div>
          ...
          <div className="w-full">
            <svg viewBox="0 0 768 384" width="100%" xmlns="http://www.w3.org/2000/svg">
              ...
              <polyline points="460,275 495,245 530,255 565,230 600,245" fill="none" stroke="#10b981" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              {[
                ...
                { texto: "Reportes Manuales", icono: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" },
                { texto: "Falta de Control", icono: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" },
                { texto: "Contratación Lenta", icono: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
              ].map((item, i) => (
                <div
                  key={i}
            ...
            <div className="space-y-6">
              {[
                { texto: "Automatización de Reportes", icono: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
                { texto: "Control Digital del Personal", icono: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
                { texto: "Reportes del Personal", icono: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
                { texto: "Apps Internas", icono: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
              ].map((item, i) => (
                <div
                  key={i}
      ...
      <section className="bg-emerald-700 text-white py-20 px-6 text-center">
        ...
        <button className="bg-white text-emerald-700 px-8 py-3 rounded-xl font-semibold shadow hover:scale-105 transition">
          Agendar ahora
        </button>
      </section>
    </main>
